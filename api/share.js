...
const OG = {
  es: { title: "SouthSide — LVCK", desc: "LVCK vuelve con SouthSide — el drop que marca nuestro nuevo capítulo. 20 AGO 2026.", locale: "es_CO" },
  en: { title: "SouthSide — LVCK", desc: "LVCK returns with SouthSide — the drop that marks our new chapter. 20 AUG 2026.", locale: "en_US" },
  pt: { title: "SouthSide — LVCK", desc: "A LVCK volta com SouthSide — o drop que marca nosso novo capítulo. 20 AGO 2026.", locale: "pt_BR" }
};
